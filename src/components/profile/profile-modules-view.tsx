...
export default function ProfileModulesView({ profile, modules, sections = [], badge, subscriptionTier = 'free' }: ProfileModulesViewProps) {
  ...
  return (
    <StyleProvider style={profileStyle}>
      ...
      >
        ...
        {/* Made by Clicky Banner - Only show for free tier */}
